...
# Download RedisShake if not exists
if [ ! -f "redis-shake-v4.4.1-darwin-arm64.tar.gz" ]; then
    echo "Downloading RedisShake 4.4.1..."
    wget https://github.com/tair-opensource/RedisShake/releases/download/v4.4.1/redis-shake-v4.4.1-darwin-arm64.tar.gz
fi

if [ ! -d "redis-shake-v4.4.1-darwin-arm64" ]; then
    echo "Extracting RedisShake 4.4.1..."
    tar xvzf redis-shake-v4.4.1-darwin-arm64.tar.gz
    mkdir -p redis-shake-v4.4.1-darwin-arm64/
    mv redis-shake redis-shake-v4.4.1-darwin-arm64/
fi
